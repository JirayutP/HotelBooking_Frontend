        ...
        profile.data.role == 'admin' ? (
            <main className="bg-slate-100 m-5 p-5">
                ...
                <form action={addHotel}>
                    <div className="text-xl text-sky-600">Create Hotel</div>
                    <div className="flex items-center w-1/2 my-2">
                        ...
                        <input type='text' required id='name' name='name' placeholder="Hotel Name" maxLength={50}
                            className="bg-white border-2 border-gray-200 rounded w-full p-2 text-gray-700 focus:outline-none focus:border-sky-500"/>
                    </div>
                    <div className="flex items-center w-1/2 my-2">
                    ...
                    <div className="flex items-center w-1/2 my-2">
                        ...
                        <input type='text' required id='district' name='district' placeholder="District"
                            className="bg-white border-2 border-gray-200 rounded w-auto p-2 text-gray-700 focus:outline-none focus:border-sky-500"/>
                    ...
                    <button type="submit" className="bg-sky-600 hover:bg-indigo-500 text-white p-2 rounded">Add New Hotel</button>
                </form>
            </main>
        ) : null
    )
